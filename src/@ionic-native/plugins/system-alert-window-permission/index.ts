 ...
 * @usage
 * ```typescript
 * import { SystemAlertWindowPermission } from '@ionic-native/system-alert-window-permission';
 *
 *
...
@Plugin({
  ...
  repo: 'https://www.npmjs.com/package/cordova-plugin-system-alert-window-permission',
